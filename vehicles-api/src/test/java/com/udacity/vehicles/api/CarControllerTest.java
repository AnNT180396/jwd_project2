...
public class CarControllerTest {
    ...
    public void findCar() throws Exception {
         ...
         */
        Car findCar = getCar();
        mvc.perform(get("/cars/{id}", findCar.getId()).accept(MediaType.APPLICATION_JSON_UTF8))
    ...
    public void deleteCar() throws Exception {
         ...
         */
        Car findCar = getCar();
        mvc.perform(delete("/cars/{id}", findCar.getId())).andExpect(status().isNoContent());
    }
    ...
    public void updateCar() throws Exception {
         ...
         */
        Car findCar = getCar();
        findCar.setCondition(Condition.NEW);
        mvc.perform(put("/cars/{id}", findCar.getId())
                .content(json.write(findCar).getJson())
                .contentType(MediaType.APPLICATION_JSON_UTF8)
